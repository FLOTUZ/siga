...
export class SolicitudRepository extends DefaultCrudRepository<
  ...
  SolicitudRelations
> {
  public readonly logSolicitud: HasManyRepositoryFactory<
    BitacoraSolicitud,
    typeof Solicitud.prototype.idSolicitud
  >;

  public readonly capturadores: HasManyThroughRepositoryFactory<
    Usuario,
  ...
  constructor(
    ...
    this.capturadores = this.createHasManyThroughRepositoryFactoryFor(
      'capturadores',
    ...
    this.registerInclusionResolver(
      'capturadores',
      this.capturadores.inclusionResolver,
    );
    this.logSolicitud = this.createHasManyRepositoryFactoryFor(
      'logSolicitud',
      bitacoraSolicitudRepositoryGetter,
    );
    this.registerInclusionResolver(
      'logSolicitud',
      this.logSolicitud.inclusionResolver,
    );
  }
}
