...
export class BeneficiarioRepository extends DefaultCrudRepository<
  ...
  BeneficiarioRelations
> {
  public readonly logBeneficiarios: HasManyRepositoryFactory<
    BitacoraBeneficiario,
    typeof Beneficiario.prototype.idBeneficiario
  >;

  public readonly personaMoral: HasOneRepositoryFactory<
    PersonaMoral,
    typeof Beneficiario.prototype.idBeneficiario
  >;

  public readonly personaFisica: HasOneRepositoryFactory<
    PersonaFisica,
    typeof Beneficiario.prototype.idBeneficiario
  >;
  ...
  constructor(
    ...
    @repository.getter('PersonaMoralRepository')
    protected personaMoralRepositoryGetter: Getter<PersonaMoralRepository>,
    @repository.getter('PersonaFisicaRepository')
    protected personaFisicaRepositoryGetter: Getter<PersonaFisicaRepository>,
  ) {
    super(Beneficiario, dataSource);
    this.personaFisica = this.createHasOneRepositoryFactoryFor(
      'personaFisica',
      personaFisicaRepositoryGetter,
    );
    this.registerInclusionResolver(
      'personaFisica',
      this.personaFisica.inclusionResolver,
    );
    this.personaMoral = this.createHasOneRepositoryFactoryFor(
      'personaMoral',
      personaMoralRepositoryGetter,
    );
    this.registerInclusionResolver(
      'personaMoral',
      this.personaMoral.inclusionResolver,
    );
    this.logBeneficiarios = this.createHasManyRepositoryFactoryFor(
      'logBeneficiarios',
      bitacoraBeneficiarioRepositoryGetter,
    );
    this.registerInclusionResolver(
      'logBeneficiarios',
      this.logBeneficiarios.inclusionResolver,
    );
  }
}
