...
export class UsuarioBitacoraUsuarioController {
  ...
  async find(
    ...
    return this.usuarioRepository.bitacoraUsuarios(id).find(filter);
  }
  ...
  async create(
    ...
    return this.usuarioRepository.bitacoraUsuarios(id).create(bitacoraUsuario);
  }
  ...
  async patch(
    ...
    return this.usuarioRepository.bitacoraUsuarios(id).patch(bitacoraUsuario, where);
  }
  ...
  async delete(
    ...
    return this.usuarioRepository.bitacoraUsuarios(id).delete(where);
  }
}
