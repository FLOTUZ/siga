...
export class BeneficiarioBitacoraBeneficiarioController {
  ...
  async find(
    ...
    return this.beneficiarioRepository.bitacoraBeneficiarios(id).find(filter);
  }
  ...
  async patch(
    ...
    @param.query.object('where', getWhereSchemaFor(BitacoraBeneficiario))
    where?: Where<BitacoraBeneficiario>,
  ): Promise<Count> {
    return this.beneficiarioRepository
      .bitacoraBeneficiarios(id)
      .patch(bitacoraBeneficiario, where);
  }
  ...
  async delete(
    ...
    return this.beneficiarioRepository.bitacoraBeneficiarios(id).delete(where);
  }
}
